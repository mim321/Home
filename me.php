      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview menu-close">
            <a href="https://github.com/mim321?tab=repositories" class="nav-link active">
...
<fieldset class="col-12 small-box" style="font-family:kanit;"><legend><b>About me</b></legend>
<style>
.bigcap{float:left;font-size:60px;line-height:0.5;margin-top:5px;margin-right:5px;margin-left:5px;color:#000088}
</style>
<p><span class="bigcap">C</span><b>สวัสดีค่ะทุกท่านที่เข้ามาอ่าน</b>
ดิฉัน นางสาวนิชาภา กะจันทร์ นิสิตมหาวิทยาลัยเนชั่น จังหวัดลำปาง
</p>
